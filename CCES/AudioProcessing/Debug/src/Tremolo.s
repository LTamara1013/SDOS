	.file "..\src\Tremolo.c";
//  Compilation time: Mon Feb  1 16:19:51 2021
...
.epcabbrev:
	.inc/binary ".\src\Tremolo.sbn", 0, 214;
.epcabbrev.end:
...
.epcdebug:
	.byte =
		0x62,0x0B,0x00,0x00,0x02,0x00;
	.var = .epcabbrev;
	.byte =
		0x04,0x01,0x2E,0x2E,0x5C,0x73,0x72,0x63,0x5C,0x54,0x72,0x65,
		0x6D,0x6F,0x6C,0x6F,0x2E,0x63,0x00,0x0C;
	.var = .epcline;
	.inc/binary ".\src\Tremolo.sbn", 214, 2859;
	.var = _delayBuffer;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x08,0x64,0x0B,0x00,0x00,0x02,0x03,
...
.epcline:
	.inc/binary ".\src\Tremolo.sbn", 3073, 618;
.epcline.end:
...
.epcpubnames:
	...
	.var = .epcdebug;
	.byte =
		0x66,0x0B,0x00,0x00,0x39,0x0B,0x00,0x00,0x64,0x65,0x6C,0x61,
