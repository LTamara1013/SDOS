...
int main(int argc, char *argv[])
{
	...
	//write("output_delay_with_feedback_c.bin",output_data,AUDIO_DATA_LENGTH);
	delay_cycles(3500000);
	...
	//write("output_tremolo_c.bin",output_data,AUDIO_DATA_LENGTH);
	...
	//write("output_flanger_c.bin",output_data,AUDIO_DATA_LENGTH);
	 delay_cycles(3500000);
	...
	START_CYCLE_COUNT(start_count);
	flanger_with_feedback(audio_data,output_data,AUDIO_DATA_LENGTH, 0.9 ,0.5, 0.5);
	STOP_CYCLE_COUNT(final_count, start_count);
	PRINT_CYCLES("Flanger with feedback: ", final_count);
	//write("output_flanger_with_feedback_c.bin",output_data,AUDIO_DATA_LENGTH);
	...
	//write("output_wahwah_c.bin",output_data,AUDIO_DATA_LENGTH);*/
